  ...
  return (
    <div className="pedidos-container">
      ...
      <div className="botones-izquierda">
        <button className="crear-contrato-button">Crear Contrato</button>
        <button className="ver-contratos-button">Ver Contratos</button>
      </div>
      
      <h1 className="titulo">Pedidos</h1>
      <h2 className="titulo-contratos">Contratos destacados</h2>
